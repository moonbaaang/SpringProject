...
public class NaverVoiceService implements NaverService{
	...
	public String test(String txtfile, String speaker) {
     ...
     try {
         String text = URLEncoder.encode("여기에 입력하세요", "UTF-8"); // 13자
         text = "";
         
         FileReader fr = new FileReader("C:\\kdigital\\images\\"+txtfile);
         BufferedReader inputbr = new BufferedReader(fr); // 한 줄씩 읽어올 수 있음
         while(true) {
